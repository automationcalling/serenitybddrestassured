package com.automationcalling.utils.restapi;
...
public class RestAssuredCore {
    ...
    public void initRestAssuredCore(String baseURI, String basePath) {
     ...
     */
    public void initRestAssuredCore(String baseURI, String basePath, String authenticationType, String usernameOrCertPath, String password) {
        RestAssured.baseURI = baseURI;
        RestAssured.basePath = basePath;
    ...
    public static void initializeLogger() throws IOException {
        printLogFile = new PrintStream(new BufferedOutputStream(new FileOutputStream(new File("src/test/java/logfile/automation.log"))), true);
